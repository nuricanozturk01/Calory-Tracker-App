...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxFoundationLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Returns the group of libraries at androidx.foundation.layout
         */
    ...
    public static class AndroidxUiLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        private final AndroidxUiUnitLibraryAccessors laccForAndroidxUiUnitLibraryAccessors = new AndroidxUiUnitLibraryAccessors(owner);
        ...
        /**
         * Returns the group of libraries at androidx.ui.unit
         */
        public AndroidxUiUnitLibraryAccessors getUnit() {
            return laccForAndroidxUiUnitLibraryAccessors;
        }
    ...
    public static class AndroidxUiUnitLibraryAccessors extends SubDependencyFactory {

        public AndroidxUiUnitLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for android (androidx.compose.ui:ui-unit-android)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getAndroid() {
                return create("androidx.ui.unit.android");
        }
    ...
    public static class PlayServicesLibraryAccessors extends SubDependencyFactory {
        private final PlayServicesAnalyticsLibraryAccessors laccForPlayServicesAnalyticsLibraryAccessors = new PlayServicesAnalyticsLibraryAccessors(owner);

        public PlayServicesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at play.services.analytics
         */
        public PlayServicesAnalyticsLibraryAccessors getAnalytics() {
            return laccForPlayServicesAnalyticsLibraryAccessors;
        }

    }

    public static class PlayServicesAnalyticsLibraryAccessors extends SubDependencyFactory {

        public PlayServicesAnalyticsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for impl (com.google.android.gms:play-services-analytics-impl)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getImpl() {
                return create("play.services.analytics.impl");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: accompanistFlowlayout (0.17.0)
            ...
            /**
             * Returns the version associated to this alias: hiltAndroidCompiler (2.50)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: playServicesAnalyticsImpl (18.0.4)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getPlayServicesAnalyticsImpl() { return getVersion("playServicesAnalyticsImpl"); }

            /**
             * Returns the version associated to this alias: uiUnitAndroid (1.6.4)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getUiUnitAndroid() { return getVersion("uiUnitAndroid"); }
